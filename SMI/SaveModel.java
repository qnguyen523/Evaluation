...
public class SaveModel implements Serializable {
	...
	public boolean equals(Object o) {
		...
		for (int i = 0; i < 5; i++) {
			if (!id[i].equals(c.id[i]))
				return false;
		}
		if (!languageField.getText().equals(c.languageField.getText()) || !total.getText().equals(c.total.getText())
	...
	public String toString() {
		String s = languageField.getText() + " " + total.getText() + " " + VAFField.getText() + " " + FPField.getText()
				+ " " + CodeSizeField.getText();
		return s;
	}
}

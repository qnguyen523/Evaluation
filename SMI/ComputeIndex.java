...
public class ComputeIndex implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (!((String) table.getValueAt(numOfRows - 1, 1)).matches("[0-9]+")
			...
			System.out.println("");
			System.out.println("");
			System.err.println("Error from ComputeIndex. " + "Users do not input non-negative numbers in the fields");
		...
		if (x.added < 0 || x.changed < 0 || x.deleted < 0) {
			System.err.println("Error from ComputeIndex. " + "You must enter non-negative number in the fields");
			JOptionPane.showMessageDialog(null, "You must enter non-negative number in the fields", "Error",
					JOptionPane.ERROR_MESSAGE);
			return;
		}
